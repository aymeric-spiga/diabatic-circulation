...
#Si quelqu'un, quelquepart trouve un jour ce code, ne me jugez pas, c'etait pour ploter la figure 10 comme je le voulais en bien, je n'avais que quelques minutes.
...
# ,logy=1 t="420,500" t=500 ,useindex="1000" ,changetime="correctls"
...
###Calcul de z en considerant Temperature constante
#z=-H*np.log(pmod.f[:,0]/p0)/1000.
###Valeurs de z dans le fichier du modele
...
###Valeurs de z depuis l'equation hypsometrique en moyennant T a chaque point du profil vertical
...
plt.title('Final Mass-Streamfunction Ls=%s' %time_step) 
plt.colorbar()
plt.yscale('log')
plt.ylabel('Pressure (Pa)')
plt.xlabel('Latitude')
...
v_nextnan[:,:]=v_next[:,:]
v_nextnan[:,42:84]=np.NaN

w_nextnan=np.empty(np.shape(w_next))
w_nextnan[:,:]=w_next[:,:]
w_nextnan[:,42:84]=np.NaN
...
#plt.close()
#exit()
lol1=w_next[19,21:106]
lol2=w_next[29,21:106]
...
plt.subplot(1, 2, 1)
plt.plot(lat[21:106],lol1*1000.,'b--')#19 1mbar
plt.plot(lat[21:106],w_next[19,21:106]*1000.,'b')#29 [21:106] 1mbar
#plt.plot(lat[21:106],w_next[38,21:106],'g')#38 0.01mbar
plt.yticks(np.arange(-0.0004*1000.,0.0004*1000.,step=0.0001*1000.)) #pour valeur fixe
#plt.yticks(np.arange(-0.0002,0.0002,step=0.00002)) #pour moyenne annuelle
plt.xticks(np.arange(-50.,55.,step=10.))
plt.legend(('1mbar ls=134','1mbar ls=308'),loc='upper right')
plt.ylabel('W(mm.s-1)')
plt.xlabel('Latitude')
plt.title('W final (mm.s-1) Ls=%s' %time_step) 
plt.grid(True)

#plt.figure(figsize=(9,5))
plt.subplot(1, 2, 2)
plt.plot(lat[21:106],lol2*1000.,'r--')#19 0.1mbar
plt.plot(lat[21:106],w_next[29,21:106]*1000.,'r')#29 [21:106] 0.1mbar
#plt.plot(lat[21:106],w_next[38,21:106],'g')#38 0.01mbar
plt.yticks(np.arange(-0.0008*1000.,0.0008*1000.,step=0.0001*1000.)) #pour valeur fixe
#plt.yticks(np.arange(-0.0002,0.0002,step=0.00002)) #pour moyenne annuelle
plt.xticks(np.arange(-50.,55.,step=10.))
plt.legend(('0.1mbar ls=134','0.1mbar ls=308'),loc='upper right')
plt.ylabel('W(mm.s-1)')
plt.xlabel('Latitude')
plt.title('W final (mm.s-1) Ls=%s' %time_step) 
plt.grid(True)
